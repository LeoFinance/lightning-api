...
import 'package:lightning_api/lightning_api.dart' as _i9;
...
class MockLightningApiClient extends _i1.Mock
    implements _i9.LightningApiClient {
  MockLightningApiClient() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Stream<_i9.Feed> getFeed({String? tag, String? sort}) => (super
      .noSuchMethod(Invocation.method(#getFeed, [], {#tag: tag, #sort: sort}),
          returnValue: Stream<_i9.Feed>.empty()) as _i5.Stream<_i9.Feed>);
  @override
  ...
  void expandFeed({String? tag, String? sort, int? amount = 20}) =>
      super.noSuchMethod(
          ...
          returnValueForMissingStub: null);
  @override
  _i5.Stream<_i9.Post> getPost(_i9.Authorperm? id) =>
      (super.noSuchMethod(Invocation.method(#getPost, [id]),
          returnValue: Stream<_i9.Post>.empty()) as _i5.Stream<_i9.Post>);
  @override
  void refreshPost(_i9.Authorperm? id) =>
      super.noSuchMethod(Invocation.method(#refreshPost, [id]),
          returnValueForMissingStub: null);
  @override
  _i5.Stream<_i9.Comments> getComments(_i9.Authorperm? id) =>
      (super.noSuchMethod(Invocation.method(#getComments, [id]),
              returnValue: Stream<_i9.Comments>.empty())
          as _i5.Stream<_i9.Comments>);
  @override
  void refreshComments(_i9.Authorperm? id) =>
