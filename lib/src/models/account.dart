...
class Account {
  Account({
    ...
    required this.tribeUpvoteWeightMultiplier,
    required this.tribeDownvoteWeightMultiplier,
    required this.tribeUpvotePower,
    required this.tribeDownvotePower,
    required this.tribeEarnedMiningToken,
    required this.tribeEarnedOtherToken,
    required this.tribeEarnedStakingToken,
